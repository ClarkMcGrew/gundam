...
//
//
//  Usage: root -b -q 'DrawEventComparison_noMichel.C+()'
//
///////////////////////////////////////////////////////////////////////////////////////
...
void DrawEventComparison_noMichel(string inputname = "fit2_dataCS_fakedataSignal_noMichel", const std::string& dir_name = "data", string fbinning = "/sps/t2k/lmaret/softwares/xsLLhFitterLM/inputs/fgd1fgd2Fit/binning/tn337_binning_GeV_format.txt")
{
