...
echo -e "cd $WORKDIR; source setup.sh; xsllhFit -j $WORKDIR/inputs/fgd1fgd2Fit/config_fit1_statFluc.json" > job_xsllh_fit1_statFluc.sh
...
qsub -l os=cl7,sps=1 -pe openmpi 16 -q pa_long -M maretlucie@gmail.com -m be job_xsllh_fit1_statFluc.sh
