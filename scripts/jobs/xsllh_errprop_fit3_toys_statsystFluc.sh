...
do
	...
	echo -e "{
    \"input_fit_file\" : \"/outputs/toysStatFluc/fit3_statFluc_toy${N}.root\",
    \"output_file\" : \"/outputs/toysStatFluc/xsec_fit3_statFluc_toy${N}.root\",
    \"extra_hists\" : \"\",
    \"proton_fsi_cov\" : \"/inputs/fgd1fgd2Fit/xsllh_covarProtonFSI.root\",
    \"num_toys\" : 10000,
    \"rng_seed\" : $((12258 + N)),
    \"sel_config\" : \"/inputs/fgd1fgd2Fit/toysStatFluc/config_fit3_toy${N}.json\",
    \"tru_config\" : \"/inputs/fgd1fgd2Fit/toysStatFluc/config_fit3_toy${N}.json\",
...
" > $WORKDIR/inputs/fgd1fgd2Fit/toysStatFluc/errprop_fit3_toy${N}.json

	# Write a file containing the job
	echo -e "cd $WORKDIR; source setup.sh; xsllhCalcXsec -j $WORKDIR/inputs/fgd1fgd2Fit/toysStatFluc/errprop_fit3_toy${N}.json" > job_xsllh_errprop_fit3_toy${N}.sh

	# Submit job
	qsub -l os=cl7,sps=1 -pe openmpi 16 -q pa_long job_xsllh_errprop_fit3_toy${N}.sh
